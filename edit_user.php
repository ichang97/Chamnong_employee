...
<br>
<div class="container">
<form class="container-fluid" id="edit" name="edit" method="post" action="cmd/edit_user.php">
<div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input name="edit_obec-id-18" class="form-control" id="edit_obec-id-18" type="text" placeholder="เลขที่ สช.11" autofocus value="<?php echo $row_show['obec_id_18']; ?>">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      <option disabled>กรุณาเลือก</option>
      <option value="1" <?php if($row_show['check_t-cert']=="1") echo 'selected' ?>>มี</option>
      <option value="2" <?php if($row_show['check_t-cert']=="2") echo 'selected' ?>>ไม่มี</option>
      </select>
    </div> 
  </div>
  <div class="form-group row">
