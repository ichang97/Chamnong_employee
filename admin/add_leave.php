...
<br>
<form class="container" id="add_leave" name="add_leave" method="post" action="cmd/add_leave">
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">เลือกบุคลากร</label>
    <div class="col-sm-10">
      <select class="form-control" required name="txt_id" id="txt_id" type="text">
    ...
    ?>
    <option value="<? echo $show_list['id'] ?>"><? echo $show_list['t_name'] ?>  <? echo $show_list['t_surname'] ?></option>
    <? } ?>
    </select>
    </div>
  </div>
