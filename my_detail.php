...
<h3>ข้อมูลส่วนตัว</h3>
  <br>
  <center><img src="admin/profile/<? echo $result['img'] ?>" class="img-rounded" width="130"></center>
  <br><br>
<table class="table">
<tbody>
    <tr>
...
<a href="edit_user?edit_id=<? echo $_SESSION['userid'] ?>" class="btn btn-primary"><i class="fas fa-edit"></i> แก้ไขข้อมูลส่วนตัว</a>
</div>
