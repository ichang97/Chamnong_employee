...
//ลากิจ
$sql_show1 = "SELECT SUM(total_diff) as sum_diff FROM qry_sumdiff WHERE s_year = '$txt_year' AND s_part = '$txt_part' AND userid = '$txt_userid' AND category = 1";
$result_show1 = mysqli_query($con,$sql_show1) or die(mysqli_error());
$row_show1 = mysqli_fetch_array($result_show1);

//ลาป่วย
$sql_show2 = "SELECT SUM(total_diff) as sum_diff FROM qry_sumdiff WHERE s_year = '$txt_year' AND s_part = '$txt_part' AND userid = '$txt_userid' AND category = 2";
$result_show2 = mysqli_query($con,$sql_show2) or die(mysqli_error());
$row_show2 = mysqli_fetch_array($result_show2);

//ลาคลอด
$sql_show3 = "SELECT SUM(total_diff) as sum_diff FROM qry_sumdiff WHERE s_year = '$txt_year' AND s_part = '$txt_part' AND userid = '$txt_userid' AND category = 3";
$result_show3 = mysqli_query($con,$sql_show3) or die(mysqli_error());
$row_show3 = mysqli_fetch_array($result_show3);

//มาสาย
//ครั้งที่มาสาย
$sql_show5 = "SELECT COUNT(docid) as sum_late FROM qry_sumdiff WHERE s_year = '$txt_year' AND s_part = '$txt_part' AND userid = '$txt_userid' AND category = 4";
